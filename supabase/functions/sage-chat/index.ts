...
- Shopping: buying physical goods online or offline that are not groceries — Amazon, Flipkart, Meesho, Myntra, Ajio, Nykaa, Nykaa Fashion, Tata Cliq, Snapdeal, ShopClues, Reliance Digital, Croma, Vijay Sales, Apple Store, Samsung Store, OnePlus, boAt, Noise, Boat headphones, clothes, shoes, bags, watches, accessories, jewellery, Tanishq, Kalyan Jewellers, furniture, home decor, Ikea, Pepperfry, Urban Ladder, electronics, mobile phones, laptops, tablets, camera, headphones, kitchen appliances, personal care devices, Dyson, Philips, gifting, stationery, toys, sports equipment (offline purchase), Decathlon

...
CATEGORY RULES:
- Use only these categories: Food & Dining, Groceries, Travel, Entertainment, Utilities, Rent, Shopping, Education, Investments, Healthcare, Subscriptions, Other
- Food & Dining: restaurants, cafes, fast food, dining out, takeout, delivery
- Groceries: supermarket, grocery store, fresh food, household items, kirana
...
Output: [
  {"amount": 10, "category": "Food & Dining", "description": "Coffee"},
...
Output: [
  {"amount": 25, "category": "Food & Dining", "description": "Lunch"},
